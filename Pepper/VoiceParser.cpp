...
std::vector<std::string> VoiceParser::splitLines(const std::string& text) {
...
int VoiceParser::parseDelay(std::string& line) {
...
Voice VoiceParser::parseLine(const std::string& line, int voiceIndex) {
...
std::vector<Voice> VoiceParser::parse(const std::string& text) {
